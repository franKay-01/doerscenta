        ...
        <div className="bg-gradient-to-r from-black h-full">
          <div className="container">
            <div className="mt-48">
              ...
              <h3 className="text-white font-bold text-2xl italic">Unlocking human potential at scale</h3>
              <h3 className="text-white text-lg mt-4">problem solvers = “doers”!</h3>
              <p className="text-white text-lg w-2/5">
                DoersCenta is the problem solver’s right-hand man. We are a community for mission-driven doers, connecting people,
                capital and ideas to solve global challenges, through a trusted, flexible, and transparent experience. And we prioritize assisting
                the doer whenever you need us, wherever you are, helping you attempt decoding the intricate calculus of problem solving,
                equitable economic growth and social harmony.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-black h-full">
          <div className="container">
            <div className="mt-48">
              ...
              <h3 className="text-white font-bold text-2xl mb-4 italic">Imagine a world where opportunity is evenly distributed</h3>
              <p className="text-white text-lg w-2/5">
                In order to solve the world’s most pressing problems, we need to examine those problems through multiple disciplinary lenses rid of the biases of race, gender,
                culture or geography. But this is not the case in our world today. DoersCenta changes all of that by giving doers, investors (or accelerators) and
                partners more flexibility, control, and peace of mind—possibility is the end game.
              </p>
            </div>
          </div>
        </div>
